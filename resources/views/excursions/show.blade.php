    ...
    <section class="pb-5">
        <div class="container">
            ...
            @if(isset($excImages[$excSlug]))
                <img src="{{ asset('images/' . $excImages[$excSlug]) }}" alt="{{ $excursion->name }}" style="width:100%; max-height:500px; object-fit:cover; border-radius:20px; display:block;">
            @elseif($excursion->cover_image)
                <img src="{{ asset('storage/' . $excursion->cover_image) }}" alt="{{ $excursion->name }}" style="width:100%; max-height:500px; object-fit:cover; border-radius:20px; display:block;">
            @else
