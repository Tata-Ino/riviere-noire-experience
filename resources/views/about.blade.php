...
@section('content')
    ...
    {{-- Mission --}}
    <section class="py-5" style="background: linear-gradient(135deg, var(--color-primary), var(--color-secondary)); color: #fff;">
        <div class="container py-5 text-center">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    <p class="lead" style="opacity: 0.9; line-height: 1.8;">
                        @if(App::getLocale() == 'en')
