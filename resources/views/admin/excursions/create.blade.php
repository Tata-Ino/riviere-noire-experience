...
@section('title', 'Créer une Excursion')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-1 fw-bold" style="letter-spacing:-0.03em;"><i class="bi bi-compass me-2" style="color:var(--vert-foret);"></i>Créer une Excursion</h4>
        <p class="text-muted mb-0" style="font-size:0.85rem;">Ajoutez une nouvelle activité</p>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="duration_minutes" class="form-control" value="{{ old('duration_minutes') }}" min="0">
                    </div>
                    <div class="mb-3">
            ...
            <button type="submit" class="btn btn-primary w-100 py-3" style="font-size:0.95rem;">
                <i class="bi bi-check-circle me-1"></i> Créer l'excursion
            </button>
        </div>
    </div>
</form>
