...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-1 fw-bold" style="letter-spacing:-0.03em;"><i class="bi bi-cup-hot me-2" style="color:var(--dore);"></i>Modifier : {{ $restaurant->translations->where('locale','fr')->first()->name ?? 'Restaurant' }}</h4>
        <p class="text-muted mb-0" style="font-size:0.85rem;">Mettez à jour les informations de ce restaurant</p>
    </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <select name="place_id" class="form-select" required>
                            ...
                            @foreach($places ?? [] as $placeOption)
                                <option value="{{ $placeOption->id }}" {{ old('place_id', $restaurant->place_id) == $placeOption->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="opening_hours" class="form-control" value="{{ old('opening_hours', $restaurant->opening_hours) }}" placeholder="Ex: Lun-Dim: 8h00 - 22h00">
                    </div>
                    <div class="mb-3">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    @if($restaurant->cover_image)
                        <img src="{{ asset('storage/' . $restaurant->cover_image) }}" class="mb-3" style="max-width:100%; border-radius:12px;" id="coverPreview">
                    @else
